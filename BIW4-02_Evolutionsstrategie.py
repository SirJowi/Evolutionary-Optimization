...
# Methoden
def suchBereichBestimmen(x, maxD, c1, c2, c3):
    """
    ...
    maxSB = np.zeros(shape=(3, 3))
    minSB = np.zeros(shape=(3, 3))
...
for idx in range(runAnz):
    ...
    maxSB, minSB = suchBereichBestimmen(x, maxD, c1, c2, c3)
